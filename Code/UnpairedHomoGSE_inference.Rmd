...
simple_llh <- function(inf.times, rem.times, N, beta, gamma){
  ...
  llh <- prod - beta * int.xy - gamma * int.y
...
Simple_MCMC_Iknown <- function(N, n.I, inf.times, rem.times, N.its, infupdate){
  ...
  ###########################
      ...
      while(it <= N.its){
            ...
            ###############################
                ...
                gamma.cur <- rgamma(n=1, shape = (n.I+nu.g), rate = (lambda.g + ints[2]))
                
                llh <- simple_llh(inf.times, rem.times, N, beta.cur, gamma.cur)
                
                # Record beta and gamma
...
Simple_MCMC <- function(N, n.I, rem.times, N.its, infupdate){
  ...
  ##############################################
      ...
      repeat{
        ...
        inf.times <- sort(inf.times)
    		...
    		if(simple_llh(inf.times, rem.times, N, beta.cur, gamma.cur) != -Inf){ break }
      }
  ...
  ###########################
      ...
      while(it <= N.its){
            ...
            ###################################
                ...
                llh.prime <- simple_llh(inf.times.prime, rem.times, N, beta.cur, gamma.cur)
...
res.list.Iknown <- Simple_MCMC_Iknown(N=100, n.I=n_I, inf.times, rem.times, N.its = 100000, infupdate = 1)
...
res.list <- Simple_MCMC(N=100, n.I=n_I, rem.times, N.its = 100000, infupdate = 1)
